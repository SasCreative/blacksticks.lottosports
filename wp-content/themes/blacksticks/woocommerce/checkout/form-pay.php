	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'blacksticks' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'blacksticks' ); ?></th>
			</tr>
		</thead>
		<tbody>
